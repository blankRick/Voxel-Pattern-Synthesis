...
int Normals(char* v_input, char* normals) {
    ...
    cout<<"initializing voxel array"<<endl;
    ...
    cout<<"Reading and storing files"<<endl;
    while(k--) {
        int x,y,z;
    ...
    //do a bfs traversal
    cout<<"Travelling all exterior voxels..."<<endl;
    bfs(0,0,0);
    cout<<"travelled"<<endl;
    ...
    cout<<"Finding all normals (this will take quite somtime...)"<<endl;
    ...
    while(vs != NULL) {
        ...
        count++;
        if((count*100/n)!=(prevCount*100/n)) {
            for(int i=(count*100/n) ; i > 0; i/=10) {
                if(i==0) cout<<"\b";
                cout<<"\b";
            }
            cout<<"\b"<<"|"<<((count*100/n))<<"%";
